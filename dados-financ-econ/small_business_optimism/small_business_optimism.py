...
# Substituindo o '/' por '-'
df_small_business_optimism['monthyear'] = df_small_business_optimism['monthyear'].str.replace('/', '-')

# Transformando a coluna 'monthyear' em datetime
df_small_business_optimism['monthyear'] = pd.to_datetime(df_small_business_optimism['monthyear'], format='%Y-%m-%d')
