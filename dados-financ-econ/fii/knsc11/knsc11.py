...
class KNSC11:
    def __init__(self):
        ...
        self.path_download = r'C:\Users\vitor\projetos_python\python_b3\web-scraping\dados-financ-econ\fii\knsc11'
    ...
    def acessar_site(self):
        self.driver.get('https://www.kinea.com.br/fundos/fundo-imobiliario-kinea-securities-knsc11/')
        sleep(1)
    ...
    def download_arquivo(self):
        ...
        novo_nome = os.path.join(self.path_download, f'knsc11_{data_arquivo}.xlsx')
