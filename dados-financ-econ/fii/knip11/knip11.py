...
class KNIP11:
    def __init__(self):
        ...
        self.path_download = r'C:\Users\vitor\projetos_python\python_b3\web-scraping\dados-financ-econ\fii\knip11'
    ...
    def acessar_site(self):
        self.driver.get('https://www.kinea.com.br/fundos/fundo-imobiliario-kinea-indices-de-precos-knip11/')
        sleep(1)
    ...
    def download_arquivo(self):
        ...
        botao_download = self.driver.find_element(By.XPATH, '//*[@id="Documentos"]/div/div/div/div[2]/div/div/div/table/tbody/tr[4]/td[3]/div').click()  # noqa: F841
        sleep(5)

        # Data do arquivo
        data_arquivo = self.driver.find_element(By.XPATH, '//*[@id="Documentos"]/div/div/div/div[2]/div/div/div/table/tbody/tr[4]/td[2]').text
        ...
        novo_nome = os.path.join(self.path_download, f'knip11_{data_arquivo}.xlsx')
